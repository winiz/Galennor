...
############################### data generators ##############################################
    ...
    MaximumTurns = numberGenerator(1,11) #MaximumTurns genrator
...
################################### yellow level ##############################################
    ...
    print
    print "Maximum turns this game? (1..10): ", MaximumTurns - 1
    print
...
########################### start to loop ################################################
    ...
    for i in range (MaximumTurns):
        ...
        if LifepointsCURRENT > 0 and Position_new != PythonShine and i == MaximumTurns - 1:    
            print "you won"
...
############################# End of the game ###########################################        
    ...
    infoupdate2(gameName,LifepointsCURRENT,swordCURRENT,diamonCURRENT)  
    restart = askTwoValues('y','n','Do you wish to play again? (y/n)')
########################################################
print 
