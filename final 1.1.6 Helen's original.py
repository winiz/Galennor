...
def infoupdate(gameName,Lifepoints,Position,r): #round #
    ...
    print "currently has",Lifepoint, "life points"
...
for i in range(MaximumTurns):
    print ' '
    print "Showing board...about to do turn num: ",i+1
    print
    print "  The board at this point contains..."
    print
    print "Showing player...about to do turn num: ",i+1
    print
    print "The player"
    print "currently has:"
    print "has a sword of material:"
    print "has BLANKBLANKNBLANK diamonds"
    print "is in position: ", Position_new
